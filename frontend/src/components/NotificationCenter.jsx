      ...
      <div className="space-y-3">
        {loading ? (
          <div className="p-12 text-center bg-white rounded-3xl border border-slate-200/80">
            ...
            <p className="text-xs text-slate-700 mt-3 font-bold">Loading real-time notifications...</p>
          </div>
          ...
          <div className="p-12 text-center bg-white rounded-3xl border border-slate-200/80 space-y-3">
            ...
            <p className="text-xs text-slate-700 max-w-sm mx-auto font-medium">
              There are no notifications matching the selected <span className="font-bold text-slate-900">"{filter}"</span> filter.
            </p>
          </div>
        ) : (
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="space-y-1">
                    ...
                    {(item.project_name || item.related_user_name) && (
                      <div className="flex items-center space-x-3 text-xs text-slate-700 font-semibold pt-1">
                        {item.project_name && (
                          <span>Project: <strong className="text-slate-900">{item.project_name}</strong></span>
                        )}
                        {item.related_user_name && (
                          <span>User: <strong className="text-slate-900">{item.related_user_name}</strong></span>
                        )}
                      </div>
                    )}
                  </div>
